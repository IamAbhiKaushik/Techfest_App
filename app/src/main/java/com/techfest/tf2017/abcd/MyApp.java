            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (int i = 0; i < 12; i++) {
                    ...
                    for (DataSnapshot postSnap : dataSnapshot.child(super_events[i]).getChildren()) {
                        ...
                        //    Log.e("MyApp",""+i);
                        //   Log.e("MyApp",HomePage.Data_super.loff.get(i).getMName().get(0));
                    ...
                    HomePage.Data_super.loff.add(new data(name.get(i), link.get(i), imglink.get(i), intro.get(i), time.get(i)));

                    //   Log.e("MyApp",""+i);
                    Log.e("MyApp", HomePage.Data_super.loff.get(i).getMName().get(0));
                    //   Log.e("MyApp",HomePage.Data_super.loff.get(i).getMName().size()+"");
